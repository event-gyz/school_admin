...
function(a) {
    ...
    c.viewtb = function() {
        var a, b = [],
        f = [showSun, showMon, showTue, showWed, showThu, showFri, showSat],
        h = {},
        i = d[e]("table"),
        j = d[e]("thead");
    ...
    c.view = function(a, f) {
        ...
        function() {
            ...
            a
        } () + "</div>" + "</div>" + "</div>" + c.viewtb + '<div class="laydate_bottom">' + '<ul id="laydate_hms">' + '<li class="laydate_sj">'+showTime+'</li>' + "<li><input readonly>:</li>" + "<li><input readonly>:</li>" + "<li><input readonly></li>" + "</ul>" + '<div class="laydate_time" id="laydate_time"></div>' + '<div class="laydate_btn">' + '<a id="laydate_clear">'+showClear+'</a>' + '<a id="laydate_today">'+ showToday +'</a>' + '<a id="laydate_ok">'+showCofirm+'</a>' + "</div>" + (b.isv ? '<a href="http://sentsin.com/layui/laydate/" class="laydate_v" target="_blank">laydate-v' + laydate.v + "</a>": "") + "</div>", d.body.appendChild(i), c.box = g("#" + h[0]), c.events(), i = null),
        c.follow(c.box),
    ...
    c.events = function() {
        ...
        e.hmss = [showHour, showMinute, showSeconds],
        e.hmsarr = [],
        c.msg = function(a, d) {
            var f = '<div class="laydte_hsmtex">' + (d || showPrompt) + "<span>×</span></div>";
        ...
        e.hmson = function(a, d) {
            ...
            c.each(e,
            function(b, e) {
                f ? c.addClass(e, h[1]) : c.timeVoid(b, d,c.hmsin[0].value) ? c.addClass(e, h[1]) : c.on(e, "click",
                function() {
