...
console.log(common_data.meet_equipment_info);
//设备
    var meet_equi = avalon.define({
        $id: "meet_equipment_info",
        data: common_data.meet_equipment_info,
    })

    meet_equi.$odata=meet_equi.$model.data
...
//酒水信息
    var water = avalon.define({
        $id: "water",
        data: common_data.water_info.data,
        hasData:function(){
            return common_data.water_info.data.length>0;
        },
        change: function(index) {
            water.data[index].total_price = water.data[index].price * water.data[index].water_people;
        }
...
//            })
            ...
            //会议室及设备报价
            $.each(meet_equi.$model.data, function(k, obj) {
                price += parseInt(obj.meetingroom_price) || 0
                price += parseInt(obj.equi_price) || 0
            ...
            //酒水报价
            $.each(water.$model.data, function(k, obj) {
                price += parseInt(obj.total_price) || 0
            })
