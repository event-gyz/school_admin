...
// 转化为整数
    ...
    Parabola.prototype = {
        ...
        initialize: function (options) {
            ...
            //this.driftY Y轴的偏移总量
            if (ops.targetEl) {
                this.driftX = toInteger(_$(ops.targetEl).get(0).getBoundingClientRect().left) - this.elOriginalLeft;

                this.driftY = toInteger(_$(ops.targetEl).get(0).getBoundingClientRect().top) - this.elOriginalTop;
