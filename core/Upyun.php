...
class Upyun{
    ...
    public function upfile($path,$type="xls,xlsx,pdf,doc,docx,zip,jpg,jpeg,gif,png"){
        ...
        $options['allow-file-type'] = $type; /// 控制文件上传的类型，可选
...
//        $options['image-height-range'] = '1,1024000'; /// 限制图片高度，可选
     ...
     * @return mixed
     */
    public function getUpfileKey($baseUrl,$type="jpg,jpeg,gif,png")
    {
        $upfile_info = self::upfile('/' . $baseUrl . '/{year}/{mon}/{day}/{random}{.suffix}',$type);
